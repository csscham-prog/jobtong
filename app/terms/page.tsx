...
4. "크레딧"이란 서비스 이용을 위해 충전하거나 무료로 제공받은 포인트로, 1크레딧 = 1회 서류 분석을 의미합니다.
...
2. 서류 전체 분석: 크레딧 사용 시 전체 분석 결과 제공 (종합 분석, 문장 개선, 강점 & 조언)
...
③ 크레딧은 결제일로부터 1개월간 사용 가능합니다. 유효기간이 경과한 미사용 크레딧은 소멸됩니다.

④ 1회 서류 분석 시 크레딧 1건이 차감됩니다.
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ background: 'rgba(230,168,0,0.1)', border: '1px solid rgba(230,168,0,0.3)', borderRadius: 16, padding: '20px 24px', marginBottom: 40 }}>
          <p style={{ fontSize: 14, color: textSub, lineHeight: 1.8, wordBreak: 'keep-all' }}>
            <strong style={{ color: point }}>핵심 요약:</strong> 잡통은 한국 취준생을 위한 서류 전형(자소서·이력서·경력기술서) 분석 서비스입니다. 가입 시 무료 분석 1회를 드리며, 추가 이용은 크레딧 구매가 필요합니다. 분석 결과는 합격률 향상을 위한 참고 자료로 활용하시기 바랍니다.
          </p>
        </div>
