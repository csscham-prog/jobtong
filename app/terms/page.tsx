...
⑤ 요금은 사전 공지 후 변경될 수 있습니다.`,
    ...
    {
      title: '제6조 (환불 정책)',
      content: `① 구매한 크레딧은 다음 조건에 따라 환불이 가능합니다.

1. 미사용 크레딧: 구매 후 7일 이내, 사용한 크레딧을 제외한 나머지 금액 환불
2. 서비스 장애로 인한 크레딧 소실: 전액 환불 또는 크레딧 복구
      ...
      <footer style={{ background: '#050b14', padding: '28px 24px', borderTop: `1px solid ${darkBorder}` }}>
        <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.25)', margin: '0 0 4px' }}>바른어플리케이션 | 대표: 조신성 | 사업자등록번호: 896-03-03938</p>
